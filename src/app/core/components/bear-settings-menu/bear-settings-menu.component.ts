  ...
  template: `
    ...
    <div #nav id="settingsSideNav" class="sidenav">
      ...
      <div class="right-sidebar__header">
        <a href="javascript:void(0)" class="closebtn" (click)="toggleNav(nav, '0', false)">&times;</a>
