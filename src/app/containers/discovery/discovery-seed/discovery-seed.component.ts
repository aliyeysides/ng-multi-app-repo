    ...
    <div class="discovery__base-stock container-fluid">
      <div class="row no-gutters">
        ...
        <div class="base-stock__actions">
          <a class="clearfix" (click)="viewStockReport(stock?.symbol)">
          ...
          <a class="clearfix" (click)="addToList({symbol: stock?.symbol, listName: 'Watching'})">
          ...
          <a class="clearfix" (click)="addToList({symbol: stock?.symbol, listName: 'Holding'})">
            <svg width="300px" height="300px" viewBox="0 0 300 300" version="1.1" xmlns="http://www.w3.org/2000/svg"
                 xmlns:xlink="http://www.w3.org/1999/xlink">
              <defs></defs>
