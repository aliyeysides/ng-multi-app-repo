  ...
  template: `
    <div class="insights__container insights__container--large">
      ...
      <div class="post-body post-body--insights">
        <h5>The Dow Jones Industrials Make a Series of All-Time Highs, but the Nasdaq and the S&amp;P&nbsp;500 Indices Lag <i class="fa fa-long-arrow-right" aria-hidden="true"></i></h5>
        <h6>Key Points</h6>
        <ul>
