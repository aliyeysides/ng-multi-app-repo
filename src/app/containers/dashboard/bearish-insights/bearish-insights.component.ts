  ...
  template: `
    <div class="insights__container insights__container--large insights__container--mainbear">
      ...
      <div class="post-body post-body--insights">
        ...
        <p>AMGN triggered a Momentum Breakout alert yesterday. The stock traded to new record highs recently after breaking out of a 6-month ascending triangle. AMGN became overbought above the upper band, which has stalled the advance.</p>
        <p>The ensuing backing & filling, however, has been constructive, with price building a potential Bull-Flag formation. Money-Flow, Relative Strength and the PGR have all remained positive during the pullback. Look to buy AMGN when the OBOS oscillator reaches oversold territory and then turns up, provided, of course, that the Chaikin Credentials hold positive. The 1-2 month price objective is 195-200.</p>
        <p>AMGN triggered a Momentum Breakout alert yesterday. The stock traded to new record highs recently after breaking out of a 6-month ascending triangle. AMGN became overbought above the upper band, which has stalled the advance.</p>
      </div>
