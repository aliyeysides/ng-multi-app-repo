...
@Component({
  ...
  template: `
    ...
    <!-- STOCK VIEW HEADER -->
      <div class="stockview__header">
        <div class="header__button header__button--left">
          <img class="align-middle" src="./assets/imgs/icon_back-arrow--white.svg">
        </div>
      ...
      <!-- STOCK VIEW NEWS -->
        <div class="row stock-info stock-info--news">
          ...
          <div class="col-1 chevron-slider chevron-slider--left">
            <img class="align-middle"  src="./assets/imgs/ui_chevron--left.svg">
          </div>
          ...
          <div class="col-1 chevron-slider chevron-slider--right">
            <img class="align-middle" src="./assets/imgs/ui_chevron--right.svg">
          </div>
          <div class="col-12">
    ...
    <!-- COMPETITION -->
      <div class="container-fluid contents contents--competition">
