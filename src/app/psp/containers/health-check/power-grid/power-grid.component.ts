          ...
          <div class="row">
            ...
            <div class="col-12 hidden-sm-up">
              <div class="row">
                ...
                <div class="col-2" style="padding:0 10px;">
                  <span class="icon__separator"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#00C04E"><path
            ...
            <div class="col-12 hidden-sm-up">
              <div class="row" style="margin-top:40px;">
                <div class="col-5"></div>
                <div class="col-2" style="padding:0 10px;">
                  <span class="icon__separator"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#FD001F"><path
