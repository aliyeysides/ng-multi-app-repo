...
@Component({
  selector: 'cpt-bear-symbol-search',
  template: `
  ...
  `,
  styleUrls: ['./bear-symbol-search.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class BearSymbolSearchComponent extends BaseSymbolSearchComponent implements AfterContentInit, OnDestroy {
